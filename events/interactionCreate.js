    ...
    switch (req) {
        case 'createTicket': {
            ...
            selectMenu.addOptions([
                {
                    label: '⚙️ | Destek',
                    description: 'herhangi bir destek için bilet açın',
                    value: 'ortaklık',
                  },
                  {
                    label: '🤝 | Partnerlik',
                    description: 'Partner yapmak için bileti aç ',
                    value: 'şikayet',
                  },
                  {
                    label: '🌟 | Pmpl/Pro',
                    description: 'Pmpl/Fire rol almak için bilet açın',
                    value: 'yetkili',
                },
            ]);
        ...
        case 'newTicket': {
            ...
            if (!channel) {
                ...
                ticketEmbed.setDescription('*Mevcut bileti kapatmak için aşağıdaki tepkiye tıklayın, uyarı geri dönülemez!*');
                ...
                return int.update({ content: `Biletiniz açık <@${int.member.id}> <#${channel.id}> ✅`, components: [], ephemeral: true });
            } else {
